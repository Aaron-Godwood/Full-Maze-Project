...
namespace graph
{
    class Graph
    {
        ...
        public void AddEdge(int node1, int node2)
        {
            int temp = 0;
            int temp2 = 0;
            if ((node1 < width * height && node2 < width * height) && (node1 % width == node2 % width || node1 / width == node2 / width))
            {
        ...
        public void RandomisedDepthFirst()
        {
            ...
            List<int> unvisitedAjacentNodes = new List<int>();
        ...
        public List<int> GetUnvisitedAdjacentNodes(int node)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (!(node % width == 0 && i == 0) && !(node % width == 3 && i == 1) && !(node / width == 0 && i == 2) && !(node / width == 3 && i == 3))
                    switch (i)
                    {
                        case 0:
        ...
        public int getRandomAdjacentNode(int node1)
        {
            ...
            while ((node1 % width == 0 && direction == 0) || (node1 % width == 3 && direction == 1) || (node1 / width == 0 && direction == 2) || (node1 / width == 3 && direction == 3))
